...
triggers: ["*ch", "*msg", "*chat", "/ch", "*chat log"]
---
# Chat Skill

## Overview

The `ch` skill posts structured messages to `agents/CHAT.md`, the shared team communication log. All personas use this to coordinate work and hand off tasks.
...
| cmd | `CMD` | `ch` | Command prefix (auto-prefixed with `*`) |
